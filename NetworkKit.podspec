Pod::Spec.new do |spec|
  ...
  spec.subspec 'NetworkQueueMocks' do |network_queue_mock_spec|
    ...
    network_queue_mock_spec.source_files  = "NetworkKit/NetworkQueueMocks/**/*.{swift,h,m}"
  end
end
