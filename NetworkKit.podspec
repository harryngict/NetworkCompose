Pod::Spec.new do |spec|
  ...
  spec.subspec 'Core' do |core_spec|
    ...
    core_spec.pod_target_xcconfig = {
      'INFO_PLIST_FILE' => '$(SRCROOT)/$(TARGET_NAME)/Info.plist',
  ...
  spec.subspec 'CoreMocks' do |core_mock_spec|
    ...
    core_mock_spec.pod_target_xcconfig = {
      'INFO_PLIST_FILE' => '$(SRCROOT)/$(TARGET_NAME)/Info.plist',
      'GENERATE_INFOPLIST_FILE' => 'YES'
    }
  end
  ...
  spec.subspec 'NetworkQueue' do |network_queue_spec|
    ...
    network_queue_spec.pod_target_xcconfig = {
      'INFO_PLIST_FILE' => '$(SRCROOT)/$(TARGET_NAME)/Info.plist',
      'GENERATE_INFOPLIST_FILE' => 'YES'
    }
  end
  ...
  spec.subspec 'NetworkQueueMocks' do |network_queue_mock_spec|
    ...
    network_queue_mock_spec.pod_target_xcconfig = {
      'INFO_PLIST_FILE' => '$(SRCROOT)/$(TARGET_NAME)/Info.plist',
      'GENERATE_INFOPLIST_FILE' => 'YES'
    }
  end
