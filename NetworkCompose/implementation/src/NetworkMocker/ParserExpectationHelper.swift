...
public final class ParserExpectationHelper {
  ...
  public func parseExpections(from data: Data,
                              responseDecoder: ResponseDecoder,
                              type: Decodable.Type,
                              path: String,
                              method: NetworkMethod,
                              queryParameters: [String: Any]? = nil) throws
    -> EndpointExpectation
  {
  ...
  ///
  /// - Returns: A `ServiceExpectation` based on the parsed data.
  public func parseExpections(from filePath: URL,
                              responseDecoder: ResponseDecoder,
                              type: Decodable.Type,
                              path: String,
                              method: NetworkMethod,
