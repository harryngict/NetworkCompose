...
// MARK: - FileManager + FileStorage

extension FileManager: FileStorage {}

// MARK: - FileSystemStorageService
...
final class FileSystemStorageService: StorageServiceInterface {
  ...
  func storeResponse<RequestType>(_ request: RequestType,
                                  data: Data,
                                  model _: RequestType.SuccessType) throws where RequestType: RequestInterface
  {
...
private extension FileSystemStorageService {
  enum Constant {
    static let homeDirectoryTitle = "NetworkCompose-FileSystemStorageService"
  }
  ...
  func storeDataToFile(_ data: Data,
                       forPath path: String) throws
  {
